     ...
     <KeyboardAvoidingView>
        ...
        <ScrollView>
          <View  style={{flex: 1, marginHorizontal: 35}}>
            ...
            <View style={{with: 60, height: 80,marginTop: 5}}>
              ...
              <View style={{ marginTop: 1, flexDirection: 'row', justifyContent: 'center'}}>  
              ...
              <View style={{flexDirection: 'row', marginTop: 10}}>
                ...
                <View style={{marginLeft: 5,position: 'absolute',top: 51}}>
                <Text style={{fontSize: 10,color: 'red'}}>Error</Text>
                </View>
                ...
                <Picker
                  ...
                  <View style={{marginLeft: 5,position: 'absolute',top: 50}}>
                  <Text style={{fontSize: 10,color: 'red'}}>Error</Text>
                  </View>
                </View>
              ...
              <View style={{borderWidth: 2,borderColor: 'orange',borderRadius: 30, padding: 15,backgroundColor: '#FFE5CC', marginTop: 10}}>
